...
COPY ./pom.xml $SPARK_HOME/jars/pom.xml

# Install maven
RUN wget --no-verbose -O apache-maven.tgz "https://dlcdn.apache.org/maven/maven-3/3.9.7/binaries/apache-maven-3.9.7-bin.tar.gz" \
    && mkdir -p /opt/maven \
